...
import com.slsoft.auth.service.UserLogonLogService;
...
public class AuthLogonHistRefreshListener implements HttpSessionListener, ServletContextListener {
    ...
    public void sessionDestroyed(HttpSessionEvent se) {
        ...
        UserLogonLogService userLogonLogService = SpringUtils.getBean(UserLogonLogService.class);
    ...
    public void contextDestroyed(ServletContextEvent sce) {
        ...
        if (!CollectionUtils.isEmpty(userLogonLogs)) {
            ...
            SessionRegistry sessionRegistry = SpringUtils.getBean(SessionRegistry.class);
