...
import static cn.fastmc.common.web.Constants.POST;
import static cn.fastmc.common.web.Constants.UTF8;
...
import cn.fastmc.common.web.Constants;
...
public class RequestUtils {
	...
	public static String getRequestedSessionId(HttpServletRequest request) {
		...
		if (request.isRequestedSessionIdFromURL() || StringUtils.isBlank(ctx)) {
			...
			// 手动从cookie获取
			String jsessionId = CookieUtils.getCookie(request,Constants.JSESSION_COOKIE);
			if (jsessionId != null) {
				return jsessionId;
			} else {
				return null;
